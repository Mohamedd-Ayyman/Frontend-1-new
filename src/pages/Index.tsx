      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Secure, accessible, and patient-centered healthcare management
            system.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Securely access your medical records, manage appointments, and
                view prescriptions from anywhere.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button
              asChild
              variant="outline"
              className="bg-transparent border-white hover:bg-white hover:text-blue-600 py-6 px-8 text-lg"
            >
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="mt-4 max-w-xs">
                Providing modern healthcare solutions for patients and
                providers.
              </p>
            </div>
